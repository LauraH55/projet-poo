...
$square2->displayArea('mm');
echo '<br>';
$square2->displayArea();
echo '<br>';

$round1 = new Round(8, "cercle 1");
$round1->displayPerimeter('mm');
echo '<br>';
...
$triangle1->displayPerimeter('mm');
echo '<br>';
$triangle1->displayPerimeter();
echo '<br>';
$triangle1->displayArea('mm');
echo '<br>';
$triangle1->displayArea();
echo '<br>';

// intérêt objets = factoriser (ne pas répéter son code)
// Objet, c'est évolutif, adaptable
// Objet, ça structure le code, design pattern
// Clareté, testable 
